...
export type PartialFormSchema = Partial<FormSchema>
...
export type FormItemComponentName = 'Input' | 'Autocomplete' | 'Cascade' | 'Checkbox' | 'ColorPicker' | 'DatePicker' | 'DateTimePicker' | 'InputNumber' | 'Radio' | 'Rate' | 'Select' | 'Virtualized Select' | 'Slider' | 'Switch' | 'Time Picker' | 'Time Select' | 'Transfer' | 'Upload'
